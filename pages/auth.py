...
class Auth:
    ...
    def choose_portal(self):
        portal = self._driver.find_element(By.CSS_SELECTOR, '.select-product__tabs a:nth-child(2)')
        portal.click()
        url = self._driver.current_url
        return url
	# https://diploma.asproagile.ru/?_auth_token=f046e941-5dcf-0d9e-711d-5bde6e85f80d&_gl=1*jlx32h*_ga*MzA5NTc5MjE5LjE2OTAxMTQ0Mjk.*_ga_HF51MD9J08*MTcyMTgzOTg1Mi4zLjEuMTcyMTg0MjYwMi4wLjAuMA..